          ...
          {!isLoading && (
            <div className="flex flex-col">
                    ...
                    <TooltipTrigger asChild>
                      <h1
                        className={cn(
                          ...
                          // The "Sweet Spot": 8xl on large screens to avoid overlap, but keep it bold
                          "font-thin text-6xl sm:text-7xl md:text-7xl lg:text-8xl xl:text-8xl",
              ...
              <div className="mt-8 flex flex-col gap-3 w-fit">
                <Link
                  href="/Siddharth%20Singh%20-%20CV.pdf"
                  target="_blank"
                  className="flex-1"
                >
                ...
                <div className="md:self-start flex gap-3">
                  ...
                  <div className="flex items-center h-full gap-2">
                    <Link href={config.social.twitter} target="_blank">
                      <Button variant="outline" aria-label="X profile">
                        <SiX size={24} />
                      </Button>
                    </Link>
                    <Link
